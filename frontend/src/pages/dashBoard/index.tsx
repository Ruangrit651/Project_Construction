...
const Dashboard = () => {
  ...
  // Render the Dashboard
  return (
    <div className="min-h-full w-full bg-gray-400 p-2 md:p-3">
      <div className="container mx-auto">
        {/* Project Filter Section */}
            ...
            <div className="mt-3 rounded-2xl border border-gray-200 bg-white shadow-lg transition-shadow hover:shadow-xl">
              <div className="p-3 flex flex-col items-center gap-3 md:gap-4 relative">
                ...
                <div className="w-full max-w-md text-center bg-gradient-to-br from-sky-50 to-sky-100 rounded-xl px-4 md:px-6 py-3 md:py-4 shadow-inner border border-sky-200">
                  ...
                  <p className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-sky-900 tracking-wide">
                    {filteredProjects ? (
                      <>
                        {calculateLocalEAC(filteredProjects)?.toLocaleString() || "N/A"}{" "}
                        <span className="text-lg md:text-xl font-medium">THB</span>
                      </>
                    ) : (
                      <span className="text-gray-400 text-base md:text-lg">Loading...</span>
                    )}
                  </p>
                </div>
              </div>
