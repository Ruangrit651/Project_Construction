...
interface DialogEditSubtaskProps {
    ...
    // เพิ่ม prop สำหรับอัพเดทแบบรักษาตำแหน่ง
    updateSubtaskInPlace?: (updatedSubtask: TypeSubTaskAll) => void;
}
...
const DialogEditSubtask: React.FC<DialogEditSubtaskProps> = ({
    ...
    const handleEditSubtask = async () => {
        try {
            ...
            // สร้างอ็อบเจกต์ subtask ที่อัพเดทแล้ว
            ...
            if (response.success) {
                ...
                // ใช้ฟังก์ชันอัพเดทแบบรักษาตำแหน่งถ้ามี
                if (updateSubtaskInPlace) {
                    updateSubtaskInPlace(updatedSubtask as TypeSubTaskAll);
                } else {
                    // ถ้าไม่มี ใช้วิธีเดิม
                    getSubtaskData();
                }
